# -*- coding: utf-8 -*-
"""
ResearchAgent — the unified entry point.
...
from research_agent.channels import get_channel_for_url, get_channel, get_all_channels
...
class ResearchAgent:
    ...
    async def search_xhs(self, query: str, limit: int = 20) -> List[Dict[str, Any]]:
    ...
    def doctor(self) -> Dict[str, dict]:
        ...
        from research_agent.doctor import check_all
        return check_all(self.config)

    def doctor_report(self) -> str:
        """Get formatted health report."""
        from research_agent.doctor import check_all, format_report
